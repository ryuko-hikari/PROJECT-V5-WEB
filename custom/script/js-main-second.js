//kalendar gambar khusus halaman depan product,news,gameplay,tutorial
var imgCalendar = document.createElement("img");
	imgCalendar.setAttribute("src", "../Assets/kalendar/april.png");
	imgCalendar.setAttribute("width", "250");
	imgCalendar.setAttribute("height", "120");
