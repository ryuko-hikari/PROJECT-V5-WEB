...
var productBody =  document.getElementsByClassName('text-stok');
	...
	// list stok STEAM
	productBody[6].innerHTML = productText[0] + productNotAvaible[0];
	productBody[7].innerHTML = productText[0] + productNotAvaible[0];
	productBody[8].innerHTML = productText[0] + productNotAvaible[0];
	// list stok cloud & account game
	productBody[9].innerHTML = productText[0] + productAvaible[1];
	productBody[10].innerHTML = productText[0] + productNotAvaible[0];
	productBody[11].innerHTML = productText[0] + productAvaible[9];
	productBody[12].innerHTML = productText[0] + productAvaible[3];
